...
var GoDebugSession = class extends import_vscode_debugadapter.LoggingDebugSession {
  ...
  inferLocalPathInGoPathFromRemoteGoPackage(remotePathWithLocalSeparator, relativeRemotePath) {
    ...
    const localGoPathSrcPath = path2.join(gopath, "src", relativeRemotePath.split((_a = this.remotePathSeparator) != null ? _a : "").join(this.localPathSeparator));
  ...
  toLocalPath(pathToConvert) {
    ...
    if (!substituteRule) {
      ...
      if (gopath && indexGoModCache > 0) {
        return path2.join(gopath, pathToConvert.substr(indexGoModCache).split((_d = this.remotePathSeparator) != null ? _d : "").join(this.localPathSeparator));
      }
    }
  ...
  async stackTraceRequest(response, args) {
    ...
    (_e = this.delve) == null ? void 0 : _e.call(((_d = this.delve) == null ? void 0 : _d.isApiV1) ? "StacktraceGoroutine" : "Stacktrace", [stackTraceIn], async (err, out) => {
      var _a2, _b2;
      if (err) {
        this.logDelveError(err, "Failed to produce stacktrace");
        return this.sendErrorResponse(response, 2004, 'Unable to produce stack trace: "{e}"', { e: err.toString() }, void 0);
      }
      ...
      let stackFrames = locations.map((location, frameId) => {
        ...
        return new import_vscode_debugadapter.StackFrame(uniqueStackFrameId, location.function ? location.function.name : "<unknown>", location.file === "<autogenerated>" ? void 0 : new import_vscode_debugadapter.Source(path2.basename(location.file), this.toLocalPath(location.file)), location.line, 0);
      });
  ...
  scopesRequest(response, args) {
    ...
    (_c = this.delve) == null ? void 0 : _c.call("ListLocalVars", ((_a = this.delve) == null ? void 0 : _a.isApiV1) ? [listLocalVarsIn] : [{ scope: listLocalVarsIn, cfg: (_b = this.delve) == null ? void 0 : _b.loadConfig }], (err, out) => {
      var _a2, _b2, _c2, _d;
      if (err) {
      ...
      (_d = this.delve) == null ? void 0 : _d.call("ListFunctionArgs", ((_b2 = this.delve) == null ? void 0 : _b2.isApiV1) ? [listLocalFunctionArgsIn] : [{ scope: listLocalFunctionArgsIn, cfg: (_c2 = this.delve) == null ? void 0 : _c2.loadConfig }], (listFunctionErr, outArgs) => {
        var _a3, _b3;
        if (listFunctionErr) {
        ...
        this.getPackageInfo(this.debugState).then((packageName) => {
          ...
          (_c3 = this.delve) == null ? void 0 : _c3.call("ListPackageVars", ((_a4 = this.delve) == null ? void 0 : _a4.isApiV1) ? [filter] : [{ filter, cfg: (_b4 = this.delve) == null ? void 0 : _b4.loadConfig }], (listPkgVarsErr, listPkgVarsOut) => {
            var _a5;
            if (listPkgVarsErr) {
  ...
  async setBreakPoints(response, args) {
    ...
    return Promise.all((_c = (_b = this.breakpoints.get(file)) == null ? void 0 : _b.map((existingBP) => {
      var _a2, _b2;
      ...
      return Promise.all((_b2 = (_a2 = args.breakpoints) == null ? void 0 : _a2.map((breakpoint) => {
  ...
  async getPackageInfo(debugState) {
    ...
    const dir = path2.dirname(((_c = (_b = this.delve) == null ? void 0 : _b.remotePath) == null ? void 0 : _c.length) || ((_d = this.delve) == null ? void 0 : _d.isRemoteDebugging) ? this.toLocalPath(debugState.currentThread.file) : debugState.currentThread.file);
    if (this.packageInfo.has(dir)) {
      return Promise.resolve(this.packageInfo.get(dir));
    }
    return new Promise((resolve2) => {
      var _a2;
      (0, import_child_process.execFile)(getBinPathWithPreferredGopathGoroot("go", []), ["list", "-f", "{{.Name}} {{.ImportPath}}"], { cwd: dir, env: (_a2 = this.delve) == null ? void 0 : _a2.dlvEnv }, (err, stdout, stderr) => {
    ...
    if ((_a = this.debugState) == null ? void 0 : _a.exited) {
      ...
      (_b = this.delve) == null ? void 0 : _b.call("ListGoroutines", [{ count: 1 }], (err, out) => {
        ...
        if (this.skipStopEventOnce) {
          log(`Skipping stop event for ${reason}. The current Go routines is ${(_c = this.debugState) == null ? void 0 : _c.currentGoroutine}.`);
          this.skipStopEventOnce = false;
          return;
        }
  ...
  evaluateRequestImpl(args) {
    ...
    const returnValue = (_d = this.delve) == null ? void 0 : _d.callPromise(((_c = this.delve) == null ? void 0 : _c.isApiV1) ? "EvalSymbol" : "Eval", [evalSymbolArgs]).then((val) => val, (err) => {
  ...
  async dumpStacktrace() {
    ...
    (_k = this.delve) == null ? void 0 : _k.call(((_j = this.delve) == null ? void 0 : _j.isApiV1) ? "StacktraceGoroutine" : "Stacktrace", [stackTraceIn], (err, out) => {
      var _a2;
      if (err) {
  ...
  async initializeRemotePackagesAndSources(delve) {
    ...
    try {
      if (!delve.isApiV1 && this.remotePackagesBuildInfo.length === 0) {
        const packagesBuildInfoResponse = await delve.callPromise("ListPackagesBuildInfo", [{ IncludeFiles: true }]);
